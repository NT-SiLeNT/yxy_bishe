...
function webViewerInitialized() {
  ...
  // 新增url传参
   // if(params.file.indexOf('seat') != -1){
  	...
  	// 	}
  	// 	}
  	// 	var  fileStr = strArr.join("&");
  	// 	var fileStr = params.file.substr(0,params.file.indexOf('?'))+'?'+fileStr;
   // }else{
  	//    var fileStr = params.file;
	   
   // }
   // 重置值-生产会有等号情况存在
   var fileStr = queryString.substring(5);
  file = "file" in params ? fileStr : appConfig.defaultUrl;
